# 설명
[loafwallet-android](https://github.com/olivingcoin-foundation/loafwallet-android) 프로젝트를 컴퓨터에 빌드하는 방법을 설명
...
```cmd
git clone -b v1.19.0 --single-branch https://github.com/olivingcoin-foundation/loafwallet-android
